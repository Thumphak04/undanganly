...
<div class="container-fluid">
    <h2 class="text-primary mb-4">Edit Template</h2>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.templates.update', $template->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" style="height:100px" name="description" id="description" placeholder="A short description of the template">{{ old('description', $template->description) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="detail_templates" class="form-label">Template Details</label>
                    <textarea class="form-control" name="detail_templates" id="detail_templates">{{ old('detail_templates', $template->detail_templates) }}</textarea>
                </div>
                ...
                <div class="row">
                   <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="price" class="form-control" id="price" placeholder="0.00" step="0.01" value="{{ old('price', $template->price) }}" required>
                        </div>
                    </div>
                     <div class="col-md-6 mb-3">
                        <label for="badge" class="form-label">Badge</label>
                        <input type="text" name="badge" class="form-control" id="badge" placeholder="e.g., New, Popular, Featured" value="{{ old('badge', $template->badge) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        @if ($template->thumbnail)
                            <div class="mt-2">
                                <img src="{{ asset('uploads/templates/' . $template->thumbnail) }}" alt="Thumbnail" width="100" class="img-thumbnail">
                            </div>
                        @endif
                    </div>
                    <div class="col-md-6 mb-3">
